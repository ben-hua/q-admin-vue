      ...
      <t-form v-show="showSearch" ref="queryRef" :data="queryParams" layout="inline">
        ...
        <t-form-item label="状态" name="status">
          <t-select v-model="queryParams.status" placeholder="部门状态" clearable style="width: 200px">
            <t-option v-for="dict in sysNormalDisable" :key="dict.value" :label="dict.label" :value="dict.value" />
          </t-select>
        </t-form-item>
        ...
        <template #topContent>
          <t-row>
            <t-col flex="auto">
              ...
              <t-button v-hasPermi="['system:dept:export']" theme="default" variant="outline">
            ...
            <t-col :span="6">
              <t-form-item label="部门状态">
                <t-radio-group v-model="form.status">
                  <t-radio v-for="dict in sysNormalDisable" :key="dict.value" :value="dict.value">{{
                    dict.label
                  }}</t-radio>
                </t-radio-group>
              </t-form-item>
...
const { sysNormalDisable } = proxy.useDict('sys_normal_disable');
